...
const blogPosts: BlogPostType[] = [
  ...
  },
  {
    ...
    excerpt: 'מיינדפולנס הוא כלי יעיל להפחתת לחץ וחרדה. במאמר זה תמצאו הסבר פשוט על מהו מיינדפולנס, יתרונותיו המגובים במחקר, וחמישה תרגילים פשוטים שתוכלו לשלב בשגרה היומית שלכם.',
