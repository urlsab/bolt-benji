    ...
    <>
      ...
      <motion.div
              ...
              >
                ...
                <a href="https://api.whatsapp.com/send?phone=+972522226181" className="bg-sky-700 btn-sky-500 hover:bg-sky-600 text-white font-bold py-3 px-6 rounded transition-colors duration-300">
