...
const faqs: FAQType[] = [
  {
    id: 1,
    question: 'כמה זמן נמשך טיפול פסיכולוגי?',
    answer: 'משך הטיפול הפסיכולוגי משתנה בהתאם לצרכים האישיים, האתגרים והמטרות של כל מטופל. בדרך כלל, טיפול קצר מועד יכול להימשך בין 8 ל-12 מפגשים, בעוד שטיפול ארוך טווח עשוי להימשך מספר חודשים ואף יותר. בפגישת ההיכרות נוכל להעריך יחד את משך הטיפול המתאים לך.'
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer: 'שכרגע אין הסדר עם קופות החולים אבל ייתכן בהמשך'
  },
  {
    id: 5,
    ...
    <section className="py-16 bg-gray-50">
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          >
            תשובות לשאלות הנפוצות ביותר לגבי טיפול פסיכולוגי
          </motion.p>
        </div>
